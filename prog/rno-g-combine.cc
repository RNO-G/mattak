...
int main (int nargs, char ** args)
{
  ...
  // In ROOT >= 6.36.0 they moved this enum around...
  #if ROOT_VERSION_CODE >= ROOT_VERSION(6, 36, 0)
    auto algo = ROOT::RCompressionSetting::EAlgorithm::kLZMA;
  #else
    auto algo = ROOT::kLZMA;
  #endif

  TFile of(args[1],"RECREATE","CombinedFile",ROOT::CompressionSettings(algo, 5));
